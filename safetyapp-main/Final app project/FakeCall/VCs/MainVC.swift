...
class MainVC: UITableViewController {
    ...
    let context = (UIApplication.shared.delegate as! AppDelegate).persistentContainerFakeCall.viewContext
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if currentSection == 0{
            ...
            if currentIndex == 0 {
                performSegue(withIdentifier: "goTimeSet", sender: self)
            }
